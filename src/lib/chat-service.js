 ...
 */
export async function sendMessage(userMessage, cv, conversationHistory = []) {
  if (AI_ENABLED) {
...
async function sendMessageAI(userMessage, cv, conversationHistory) {
...
async function sendMessageMock(userMessage, cv) {
